...
nav ul li a:hover{
    ...
    <div class="label">
    <h2 class="judul">HITUNG ZAKAT FITRAH</h2>
        <form method = "post" action = "zakatfit.php">
        <label>Harga Beras Per liter</label><br><br>
...
if ($_SERVER ['REQUEST_METHOD']== "POST"){
 ...
 echo "Maka Zakat fitrah yang harus dibayarkan
  adalah sebesar Rp $rumusfit atau 3,5 liter beras <br/><br><br>";
}
?>
